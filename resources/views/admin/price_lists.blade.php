                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.price-lists.store') }}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            <label for="servis">Pelayanan</label>
                                            <div class="row">
                                                <div class="col-8">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            <label for="harga-modal">Harga Yang Dipasang</label>
                                            <input type="number" class="form-control" id="harga" name="price"
                                                required>
                                        </div>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-success">Tambahkan Harga</button>
                            </form>
                            <hr>
                            <h5 class="mt-3">Daftar Harga Barang</h5>
                            <ul class="nav nav-tabs mt-3" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="meter-tab" data-toggle="tab" href="#meter" role="tab"
                                        aria-controls="meter" aria-selected="false">Meter</a>
                                </li>
                            </ul>
                            <div class="tab-content mt-3" id="myTabContent">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" class="badge badge-danger btn-ubah-harga"
                                                            ...
                                                            <a href="/delete/{id} class="badge badge-danger btn-ubah-harga"
                                                            data-id="{{ $item->id }}" data-toggle="modal"
                                                            data-target="#changePriceModal">Hapus</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                ...
                                <div class="tab-pane fade" id="meter" role="tabpanel" aria-labelledby="meter-tab">
                                    <table id="tbl-meter" class="table dataTable dt-responsive nowrap"
                                        style="width:100%">
                                        <thead class="thead-light">
                                            <tr>
                                                <th>No</th>
                                        ...
                                        <tbody>
                                            @foreach ($meter as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->item->name }}</td>
                                                    <td>{{ $item->service->name }}</td>
                                                    <td>{{ $item->getFormattedPrice() }} /M</td>
                                                    <td>
                                                        <a href="#" class="badge badge-danger btn-ubah-harga"
                                                            data-id="{{ $item->id }}" data-toggle="modal"
                                                            data-target="#changePriceModal">Ubah Harga</a>
