...
Route::group([
    ...
    Route::get('transaction_input', [TransactionController::class, 'create'])->name('transaction_input');
    // dibuatkan seperti ini
});

Route::get('/delete/{id}', [PriceListController::class, 'delete'])->name('delete');
// Set language route
